...
def main(config):
    ...
    for dataset_name in config["datasets"]:
        ...
        for data_split_type in ["train", "test"]:
            if data_split_type in data_config:
                    ...
                    # DEBUG
                    # print(f"Dataset type: {data_split_type}")
                    # print(f"Dataset name: {dataset.dataset_name}")
                    # print(f"trajectory: {len(dataset.traj_names)}")
                    # print(f"Number of samples: {len(dataset)}")
                    # print(f"Number of indexes: {len(dataset.index_to_data)}")
                    # print(f"Number of goal indexes:: {len(dataset.goals_index)}")
    ...
    # Create the model
    if config["model_type"] == "fastnav":
        if config["vision_encoder"] == "fastnav_encoder":
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="RGB-Only Visual Navigation")

    # project setup
    parser.add_argument(
        "--config",
        "-c",
        default="config/fastnav_teacher.yaml",
        type=str,
